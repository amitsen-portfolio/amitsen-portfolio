    ...
    <html lang="en" className="!scroll-smooth">
      ...
      >
        ...
        <div className="fixed top-0 left-0 right-0 bottom-0 -z-10">
          ...
          <div className="bg-[#d497a0] absolute top-[-6rem] right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] dark:bg-[#946263]"></div>
          {/* Second gradient circle */}
          <div className="bg-[#9bd0c3] absolute top-[-1rem] left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#0a0531]"></div>
        </div>
