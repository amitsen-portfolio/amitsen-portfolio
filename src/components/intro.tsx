  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link
          href="#contact"
          className="group bg-slate-900 text-slate-200 px-7 py-3 flex items-center gap-2 rounded-full border border-slate-400 outline-none hover:scale-110 hover:bg-slate-950 transition-all cursor-pointer dark:text-slate-300"
          onClick={() => {
        ...
        {/* Download CV button */}
        <a
          className="bg-slate-200 text-slate-800 px-7 py-3 flex items-center gap-2 rounded-full border border-slate-700 outline-none hover:scale-110 transition-all cursor-pointer dark:bg-white/10 dark:text-slate-300 dark:border-slate-300"
        ...
        <a
          className="bg-slate-200 text-slate-700 p-4 flex items-center gap-2 text-[1.25rem] rounded-full border border-slate-700 outline-none hover:scale-[1.15] transition-all cursor-pointer tooltip dark:bg-white/10 dark:text-slate-300 dark:border-slate-300"
        ...
        {/* GitHub profile link */}
        <a
          className="bg-slate-200 text-slate-700 p-4 flex items-center gap-2 text-[1.35rem] rounded-full border border-slate-700 outline-none hover:scale-[1.15] transition-all cursor-pointer tooltip dark:bg-white/10 dark:text-slate-300 dark:border-slate-300"
